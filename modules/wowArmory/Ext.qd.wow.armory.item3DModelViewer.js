Ext.qd.wow.armory.item3DModelViewer = Ext.extend(Ext.Panel, {  
  initComponent : function() {
    ...
    Ext.qd.wow.armory.item3DModelViewer.superclass.initComponent.apply(this, arguments);

  },
  onRender:function(ct, position) {
    Ext.qd.wow.armory.item3DModelViewer.superclass.onRender.call(this, ct, position);
    Ext.Ajax.request({
      url           : 'proxy.php',
      params        : { 
...
Ext.reg('wowItem3DModelViewer',Ext.qd.wow.armory.item3DModelViewer);