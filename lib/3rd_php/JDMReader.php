...
//		curl_setopt($ch, CURLOPT_COOKIE, $this->_cookie);
	...
	public function listAll($folder="reading-list",$args='') {
		$gUrl = "http://www.google.com/reader/api/0/stream/contents/user/-/state/com.google/".$folder;
		http://www.google.fr/reader/api/0/stream/contents/user/09913341761329209956/state/com.google/starred?n=20&ck=1301160923759&client=scroll
		$args = ($args?$args.'&':'').sprintf('ck=%1$s', time());
