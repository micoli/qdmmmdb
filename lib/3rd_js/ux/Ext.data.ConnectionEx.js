...
Ext.define('Ext.data.ConnectionEx', {
		...
		if (me.fireEvent('beforerequest', me, options) !== false) {
			...
			request = {
				...
				timeout: setTimeout(function() {
					...
					if(Ext.globalAjaxHandler) Ext.globalAjaxHandler('timeout',request);
					me.abort(request);
			...
			// start the request!
			if(Ext.globalAjaxHandler) Ext.globalAjaxHandler('start',request);
	...
	onComplete : function(request) {
		...
		if (success) {
			if(Ext.globalAjaxHandler) Ext.globalAjaxHandler('requestcomplete',request);
			...
			if(Ext.globalAjaxHandler) Ext.globalAjaxHandler('requestexception',request);
