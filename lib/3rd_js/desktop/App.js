...
Ext.define('MyDesktop.App', {
	...
	init: function() {
		...
		that.appItems = [
			...
			{title		: 'File Explorer'	,iconCls	:'auto',xtype	: 'qd.system.fileExplorer'								},
			{title		: 'File Indexer'	,iconCls	:'auto',xtype	: 'qd.mediadb.indexer'									},
			{title		: 'XBMC Database'	,iconCls	:'auto',xtype	: 'qd.mediadb.xbmcDB'								},
		];
		...
		var autoExec = [];
		//var autoExec = ['qd.system.fileExplorer-File Explorer'];
		//var autoExec = ['qd.mediadb.indexer-File Indexer'];
